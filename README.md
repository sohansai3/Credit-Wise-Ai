...
Risk categories:300-500: High Risk
501-650: Medium Risk
651-850: Low Risk
...
Register a user.
Choose Admin for the first administrative account, or Loan Officer for normal usage.
Create a new credit card assessment.
Review the decision, credit score, risk level, recommended credit limit, and explanation.
Download the PDF report from the result or application history page.
...
Trains and compares:Logistic Regression
Random Forest
XGBoost
